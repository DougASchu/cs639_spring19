# Douglas Schumacher, HW 4 Attempt #2, CS 639, Spring 2019
# SVM code inspired by http://benalexkeen.com/support-vector-classifiers-in-python-using-scikit-learn/
...
model = SVC(kernel='rbf', C=1, gamma= 'auto', random_state=1)
...
with open('submission_2.csv', mode='w') as sub_file:
